 ...
 *
 * Координирует преобразование вложенных сущностей: списка вариантов ответа ([Choice]) и данных об использовании токенов ([Usage])
 * с помощью специализированных мапперов [ChoiceMapper] и [UsageMapper]. Это способствует соблюдению принципа единственной ответственности
...
class ChatResponseMapper(
     ...
     * @return Доменная модель [ChatResponse], содержащая преобразованные варианты ответа и метаданные использования токенов.
     */
