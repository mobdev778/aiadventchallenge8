...
class ChatClientRepository(
     ...
     *
     * @param request доменная модель запроса, содержащая параметры генерации (модель, сообщения, температуру, инструменты и т.д.)
     * @return доменная модель ответа [ChatResponse] с вариантами сгенерированных сообщений и метаданными использования токенов
     */
