    ...
    companion object {
        ...
        val default: Profile = Profile(
            ...
            content = """
                ...
                - Task Completion: Never close a task with an empty message or a raw output block alone. Always explicitly state that the task has been completed and briefly summarize what was done.
