 ...
 *
 * @property intermediate Признак промежуточного ответа (true — ответ не является финальным, false — окончательный результат).
 ...
 * @property toolMessages Список ответов от использованных инструментов ([ToolResponse]), полученных в ходе обработки запроса.
 ...
 * @property taskContext Обновлённый [TaskContext] для задачи, с которой связан запрос, или `null`, если контекст не обновлялся.
 */
